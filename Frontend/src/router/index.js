  ...
  routes: [
    ...
    // --- Freelancer ---
    {
      ...
      children: [
        ...
        { path: 'lawyer-reviews', component: () => import('@/views/freelancer/LawyerReviewsList.vue') },
        { path: 'lawyer-reviews/:id', component: () => import('@/views/freelancer/LawyerReviewDetail.vue') },
